    ...
    return (
      <div className='page'>
        ...
        <p>
          ...
          Netherlands-based OLX group in certain key markets, and was valued at $1 Billion, giving it the coveted
          unicorn status. The group now also owns and operates Bayut in the UAE, OLX Pakistan, OLX Egypt and OLX
          Lebanon, in addition to several other platforms in the broader Middle East region, including Saudi Arabia,
          Bahrain, Oman, Kuwait and Qatar. Now situated in the heart of Dubai Design District, Dubai’s skyline may have
          changed, but dubizzle has not, and there is so much more to come. If you need anything to buy or sell, all you
          need is dubizzle! Yalla, let’s go.
        </p>
      </div>
    );
  }
